...
```
/home/james/Documents/portfolio-profile/records/folio/chat-record-[timestamp].md
```

**Important**: Chat records are stored in the portfolio-profile project, not in this folio directory. This keeps data/documentation separate from code.
...
The section title should describe the content (e.g., "RAG System Implementation", "Event System Architecture", "Avatar Emotion System", "Color Palette Design Decisions", "Compact Context File Implementation", "Rate Limiting Strategy", "Frontend Component Architecture").
...
- **Always create file in** `/home/james/Documents/portfolio-profile/records/folio/` folder (portfolio-profile project, not folio directory)
