...
I combine artistic intuition with technical rigor. My art background gives me a gut sense for when code structure feels wrong or when project architecture will produce bugs later. I catch issues early through pattern recognition my artistic training developed. I can follow an instinct on what might be causing a bug and usually be right, then follow up with rigorous logical investigation. The intuition acts as a compass, not proof.

I know when something is done. When working on a painting or throwing a pot, there's a point where you know things are exactly right - anything more makes it worse or wastes effort. Skill developed through years in art. I know when a system is stable and functional and adding more is perfectionism rather than professionalism. The Integrations Dashboard has run 3+ years without maintenance.
