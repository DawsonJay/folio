...
I've built three production Python projects, all with AI/ML at the core.

WhatNow is an AI-powered activity recommendation system. Python backend with FastAPI, contextual bandits and reinforcement learning, semantic embeddings, and a two-layer learning architecture. I use it in daily life.
