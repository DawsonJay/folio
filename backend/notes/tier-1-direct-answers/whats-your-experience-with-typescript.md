...
I'm comfortable with generics, discriminated unions, mapped types, utility types, and the patterns that make large TypeScript codebases maintainable. React and TypeScript together is where I deliver the most immediate value.
