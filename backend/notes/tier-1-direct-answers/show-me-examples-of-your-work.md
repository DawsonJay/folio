...
moh-ami is LLM integration for real-world problems - translation explanations, contextual learning, and intuitive UI for complex functionality. The synchronized side-by-side text comparison with hover interactions and semantic chunking makes language learning natural.

My GitHub has full source code for personal projects. Portfolio website includes detailed project pages explaining technical decisions, challenges solved, and lessons learned. The best demonstration is Folio itself - you're experiencing the quality of my AI implementation right now through this conversation.
