...
TypeScript has been my primary language across 5.5 years of professional work — BriefYourMarket, freelance, and Nurtur — with the React + TypeScript pairing from Ironhack (May 2020) onward. The deepest stretch was my 3.5 years at Nurtur. It's the language I think in when building frontend systems.
