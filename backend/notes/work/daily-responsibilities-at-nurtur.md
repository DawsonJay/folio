...
**Team collaboration project**: Built alongside other developers.

**My specific contributions**:
- Implemented Redux Toolkit for editor state management
- Integrated Lexical framework for rich text editing
- Created link editor component
- Mentored backend developers transitioning to frontend work
- Helped deploy to production

**Challenge**: Complex state management (document content, selection, history, collaboration, UI state) required thoughtful architecture.

### Integrations Dashboard

**Solo full-stack project**: Built entirely by me to bridge backend and sales teams.

**Responsibility**:
- Gathered requirements from both technical (backend) and non-technical (sales) stakeholders
- Designed and implemented both frontend and backend
- Deployed to production
- Maintained initially, but it's been stable for 3+ years with zero ongoing maintenance

**Impact**: Increased sales team productivity significantly by making backend data accessible and intuitive.
...
- CSS/SCSS and Tailwind CSS for styling
...
**What I've learned**:
- Production system development at scale
- Working in established codebases
- Collaborating with diverse teams
- Long-term maintainability thinking
- Redux Toolkit and complex state management
